-- ==============================================================================
-- AUTOMOTIVE TECHNICAL SUPPORT MANAGEMENT SYSTEM - DATABASE INITIALIZATION
-- Runs automatically when the MySQL Docker container boots up for the first time.
-- ==============================================================================
...
-- 11. Status transition audit table
...
SET @admin_password_hash = '$2a$10$Wlm5P/Is28IZTS41bOGtcuuDDd2qc5srd3K0X0wqzRKWi2Mezwc9e';

SET @technician_one_username = 'tecnico1';
SET @technician_one_full_name = 'Juan Perez';
SET @technician_one_specialty = 'Mecanica General y Frenos';

SET @technician_two_username = 'tecnico2';
SET @technician_two_full_name = 'Andres Lopez';
SET @technician_two_specialty = 'Diagnostico Electrico y Motor';
